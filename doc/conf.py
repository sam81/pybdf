...
# -*- coding: utf-8 -*-
#
# pybdf documentation build configuration file, created by
# sphinx-quickstart on Fri May 17 01:15:48 2013.
#
...
latex_documents = [
  ('index', 'pybdf.tex', 'pybdf Documentation',
   'Samuele Carcagno', 'manual'),
]
...
man_pages = [
    ('index', 'pybdf', 'pybdf Documentation',
     ['Samuele Carcagno'], 1)
]
...
texinfo_documents = [
  ('index', 'pybdf', 'pybdf Documentation',
   'Samuele Carcagno', 'pybdf', 'One line description of project.',
   'Miscellaneous'),
]
